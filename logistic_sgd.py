...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=1000,
    ...
    tr_px = path + "pairs-NO_2013/vectors_H20/pairs_eng-NO-test-2e6-nonempty_OnWN_d2v_H20_sub_m5w8.mtx"                                                           
    tr_py = path + "pairs-NO_2013/STS.gs.OnWN.txt"                                   
    ts_px = path + "pairs-SI_2014/vectors_H20/pairs_eng-NO-test-2e6-nonempty_deft-news_d2v_H20_sub_m5w8.mtx"
    ts_py = path + "pairs-SI_2014/STS.gs.deft-news.txt"
    vl_px = path + "pairs-NO_2013/vectors_H20/pairs_eng-NO-test-2e6-nonempty_FNWN_d2v_H20_sub_m5w8.mtx"
   ...
   ######################                                                            
    ...
    classifier = LogisticRegression(input=x, n_in=in_dimensions, n_out=k_classes)
...
# batch_size=20, learning_rate=0.13
    sgd_optimization_mnist(learning_rate=0.08, n_epochs=1000000)
